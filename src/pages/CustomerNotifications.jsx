    ...
    <div className="min-h-screen bg-gray-50" dir={lang === 'ur' ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        : <div className="space-y-2">{notifications.map(n => (
          <div key={n.id} onClick={() => markAsRead(n.id)} className={`p-4 rounded-2xl border cursor-pointer transition-all ${n.is_read ? 'bg-white border-gray-100' : 'bg-purple-50 border-purple-100'}`}>
