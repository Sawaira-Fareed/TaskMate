...
export default function MyRequests() {
  ...
  const statusBadge = (status) => {
    const map = {
      ...
      contacting: 'bg-purple-50 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
      ...
      expired: 'bg-gray-50 text-gray-600 dark:bg-gray-700 dark:text-gray-300',
